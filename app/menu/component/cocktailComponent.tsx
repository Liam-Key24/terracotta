...
export default function CocktailMenu() {
  return (
    <div className="w-auto h-auto flex flex-col md:space-x-10 space-y-6 md:space-y-0 md:flex-row-reverse">

      {/* RIGHT SIDE (IMAGE) */}
      <div className="relative inset-0 md:w-1/2">
        <div className="absolute inset-0 z-30 flex justify-center items-center">
          <h2 className="text-5xl text-white/80">Cocktails</h2>
        </div>

        <div className="relative h-50 md:h-[30vh] inset-0 bg-[url(/assets/menu/cocktails.jpg)] bg-cover bg-center rounded-lg"></div>
